...
public class OrientedPhysics : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            entity.altitude = entity.altitude + entity.climbingHeight * Time.deltaTime;
        }
        else if (entity.desiredAltitude < entity.altitude)
        {
            entity.altitude = entity.altitude - entity.climbingHeight * Time.deltaTime;
        }
       // entity.speed = Utils.Clamp(entity.altitude, entity.minSpeed, entity.maxSpeed);
        //

        entity.velocity.x = Mathf.Sin(entity.heading * Mathf.Deg2Rad) * entity.speed;
        entity.velocity.y = Mathf.Sin(entity.altitude * Mathf.Deg2Rad) * entity.climbingHeight;
